...
from silicon_valley.app.ports.input.piper_gilfoyle_system_use_case import (
    GilfoyleSystemUseCase,
)
from silicon_valley.dependencies.piper_gilfoyle_system_provider import (
...
async def introduce_myself(
    ...
    return await gilfoyle.introduce_myself(
        GilfoyleSystemSchema(id=4, name="버트람 길포일 (Bertram Gilfoyle)")
    )
