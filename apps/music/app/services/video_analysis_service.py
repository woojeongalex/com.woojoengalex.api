...
from music.app.services.emotion_analysis import analyze_emotion, emotions_for_json
from music.app.services.librosa_vocal_analysis import analyze_pitch_bpm_duration
from music.app.services.video_audio_preprocess import (
    VIDEO_EXTENSIONS,
...
class VideoAnalysisService:
    ...
    def analyze_video_bytes(self, data: bytes, original_filename: str) -> VideoVocalAnalysisResponse:
        if not data:
