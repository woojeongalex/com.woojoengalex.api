...
from music.adapter.inbound.api.schemas.instrument_fletcher_tuner_schema import (
...
from music.adapter.inbound.api.schemas.speech_herald_recorder_schema import (
...
from music.adapter.inbound.api.schemas.vocal_bard_searcher_schema import (
    SongMrHitResponse,
...
def to_instrument_catalog_response(
    dto: InstrumentCatalogResultDto,
) -> InstrumentCatalogResponse:
...
def to_instrument_response(
    dto: InstrumentEvaluationResultDto,
) -> InstrumentEvaluationResponse:
...
def to_video_analysis_response(
    dto: VideoVocalAnalysisResultDto,
) -> VideoVocalAnalysisResponse:
