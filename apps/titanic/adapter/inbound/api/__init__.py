...
from titanic.adapter.inbound.api.v1.crew_smith_captain_router import (
...
from titanic.adapter.inbound.api.v1.passenger_ruth_survivor_router import (
    ruth_survivor_router,
)
