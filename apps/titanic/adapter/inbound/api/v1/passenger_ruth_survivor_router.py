...
from titanic.adapter.inbound.api.schemas.passenger_ruth_survivor_schema import (
    RuthSurvivorSchema,
)
...
from titanic.dependencies.passenger_ruth_survivor_provider import (
...
async def introduce_myself(
    ...
    return await ruth.introduce_myself(
        RuthSurvivorSchema(id=12, name="루스 드윗 부카터 (Ruth DeWitt Bukater)")
    )
