...
def configure_logging() -> None:
    ...
    for name in (
        ...
        "music.app.use_cases.list_service",
        ...
        "music.app.use_cases.video_analysis_service",
        "music.app.use_cases.evaluation_service",
        "music.app.use_cases.suggest_service",
        "music.app.use_cases.instrument_service",
        "music.app.use_cases.speech_service",
